...
# Де функція для вибору всіх проектів - select_projects, 
# функція для вибору всіх завдань - select_all_tasks і, наприклад, 
# функція вибору всіх завдань за статусом - select_task_by_status.
